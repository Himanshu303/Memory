...
const {truncate,stripTags,editIcon,statusList,formatDate}=require("../helpers/ejs");
...
router.get("/:id",ensureAuth,async(req,res)=>{
  try{
    ...
    res.render('stories/show',{story,stripTags,editIcon,formatDate,layout:'layouts/boilerplate'})
...
router.get("/",ensureAuth,async(req,res)=>{
    try {
      ...
      res.render('stories/index',{stories,layout:'layouts/boilerplate',truncate,stripTags,editIcon})
...
router.get("/edit/:id",ensureAuth,async(req,res)=>{
  try {
   ...
   if(req.user.id!=story.user){
    ...
    return res.render("stories/edit",{story,statusList,layout:'layouts/boilerplate'})
   }
  }
  catch(err)
  {
...
router.get("/user/:userId",ensureAuth,async(req,res)=>{
  try {
    ...
    res.render("stories/index",{stories, truncate,stripTags,editIcon,layout:'layouts/boilerplate'})
